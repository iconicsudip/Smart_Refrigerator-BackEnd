...
urlpatterns = [
    ...
    path('getuserdashboard/start=<int:start>',views.get_user_dashboard,name='get_user_dashboard'),
    ...
    path('getrecipies/<str:item>/start=<int:start>',views.getRecipies,name='get_recipies'),
    ...
    path('userrecipes/<str:username>/start=<int:start>',views.userrecipes,name='user_recipes'),
